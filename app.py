...
# Global CSS for a cleaner, modern look
st.markdown(
    """
    <style>
    .main > div {padding-top: 1rem; padding-bottom: 2rem;}
    .stMetric {background: #ffffff; border: 1px solid #eee; border-radius: 12px; padding: 16px;}
    ...
    .stTabs {margin: 8px 0 16px 0;}
    .stTabs [data-baseweb="tab-list"] {gap: 14px;}
    .stTabs [data-baseweb="tab"] {background: #f3f4f6; border-top-left-radius: 8px; border-top-right-radius: 12px; padding: 10px 16px;}
    </style>
    """,
